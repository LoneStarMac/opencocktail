---
name: x40-firmware-porter
description: "Firmware porting engineer for the CocktailAudio X40 project. Use this skill when extracting assets from the original firmware (graphics, fonts, UI layouts, database schemas, audio configs), building the replacement software stack, writing the Pico 2 firmware, creating the host daemon, or porting any functionality from the original MIPS/Sigma Designs system to the new architecture. Trigger for: firmware porting, asset extraction, Pico firmware, USB serial protocol, audio daemon, web UI, ripping pipeline, music library, cfg parser, I2C driver, GPIO driver, PIO, TinyUSB, or building any part of the cocktail-revive software."
---
